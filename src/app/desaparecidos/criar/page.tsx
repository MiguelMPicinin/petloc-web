...
export default function CriarDesaparecidoPage() {
  const { user } = useAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError('Erro ao cadastrar desaparecido: ' + error.message);
    } finally {
      setLoading(false);
    }
  };
      ...
      <header className="header">
        <div className="header-content">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-xl font-bold">Reportar Desaparecimento</h1>
          </div>
        </div>
      </header>
          ...
          <div className="card space-y-6">
            ...
            <div className="form-group">
              ...
              <textarea
                ...
                placeholder="Descreva seu pet: raça, idade, características, última localização, detalhes do desaparecimento..."
                required
              />
            </div>
            ...
            <div className="form-group">
              ...
              <input
                ...
                className="form-input"
                placeholder="Telefone, WhatsApp, email para contato..."
                required
              />
            </div>
